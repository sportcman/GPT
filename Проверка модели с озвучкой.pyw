...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.temp_slider.setMaximum(10) # параметр температуры
        self.temp_slider.setValue(1)
        layout.addWidget(QLabel("Температура:"))
        layout.addWidget(self.temp_slider)
        self.temp_value_label = QLabel("0.1", self) # параметр температуры
    ...
    def update_temp_label(self, value):
        temperature = value / 100 # параметр температуры
        self.temp_value_label.setText(f"{temperature:.10f}") # параметр температуры
